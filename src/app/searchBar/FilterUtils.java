...
public final class FilterUtils {
    ...
    /**
     * Filters a list of {@link LibraryEntry} objects based on the provided {@link FilterCriteria}.
     *
     * @param entries  The list of LibraryEntry objects to filter.
     * @param criteria The FilterCriteria used to determine which entries to include.
     * @return A new list containing the filtered LibraryEntry objects.
     */
